...
Current live-demo checkpoint: `LIVE-DEMO-007-human-readable-transcript-and-plain-qualification` is the resumed work before any `PROD-102` or production-promotion effort. It is supervised demo hardening for human-readable transcript review and plain early qualification, not full production sales closure.
