...
Current live-demo checkpoint: `LIVE-DEMO-006-memory-transcript-visibility` is the resumed work before any `PROD-102` or production-promotion effort. It is supervised demo hardening for local transcript reviewability and compact memory repetition diagnostics, not full production sales closure.
