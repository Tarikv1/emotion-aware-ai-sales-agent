...
Current live-demo checkpoint: `LIVE-DEMO-009-appointment-lead-close` is the resumed work before any `PROD-102` or production-promotion effort. It is supervised demo hardening for one-question opening behavior and appointment-setting as the current MVP close, not full production sales closure or payment collection.
