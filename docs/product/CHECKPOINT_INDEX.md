...
Current live-demo checkpoint: `LIVE-DEMO-008-prosody-review-scope-clarity` is the resumed work before any `PROD-102` or production-promotion effort. It is supervised demo hardening for provider-rendered phrase-flow and buyer-facing workflow-review scope clarity, not full production sales closure.
