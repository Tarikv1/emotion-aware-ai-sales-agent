...
- What was learned: conditional customer simulation is a better inspection target than a same-case text rerun. PROD-040 creates `8` calls and `19` customer turns with conditional customer turn count `19`, agent-conditioned customer reply count `19`, unique customer response count `19`, repeated customer response count `0`, CallCenterEN pattern source count `59`, scenario bank source count `8`, accepted deals `4`, rejected deals `4`, hard failures `0`, payment collection count `0`, and leakage findings `0`.
