...
- [ ] Current: run `RAG-016` quote-clearance batches for the remaining `30` original quote-clearance chunks, while keeping source-mapping decisions from RAG-015 as human-review work and runtime retrieval disabled.
