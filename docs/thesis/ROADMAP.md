...
- [ ] Current: run `RAG-016A` quote-clearance decision slice from the RAG-016 batches, accepting only project-owned low-pressure paraphrases or rejecting unsafe candidates while keeping runtime retrieval disabled.
