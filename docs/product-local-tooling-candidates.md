...
| Realtime turn CLI | `scripts/realtime_turn_cli.py`, `docs/product/REALTIME_TURN_CLI.md` | Exercise the latency-critical sales-agent core one turn at a time. | Already product-local. | Keep and eventually make it the official smoke test for the live core. |
