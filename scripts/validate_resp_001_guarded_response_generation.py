...
def main() -> None:
    ...
    assert_condition(retrieval_payload["final_response"] != safe_payload["final_response"], retrieval_payload)
    assert_condition("nicht am punkt vorbeirede" in retrieval_payload["final_response"].lower(), retrieval_payload["final_response"])
