...
def validate_payload(payload: dict[str, Any], report: str) -> None:
    ...
    assert_condition(summary["opt_in_hooked_answer_count"] >= 1, summary)
    ...
    assert_condition(summary["hooked_wins_vs_baseline"] >= 1, summary)
    ...
    assert_condition(by_label["price_objection"]["composer_hooks"]["applied"] is False, by_label["price_objection"])
