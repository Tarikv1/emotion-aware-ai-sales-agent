...
def main() -> None:
    ...
    assert_condition(enabled_payload["final_response"] != default_payload["final_response"], enabled_payload)
    assert_condition("nicht am punkt vorbeirede" in enabled_payload["final_response"].lower(), enabled_payload["final_response"])
