...
PROMPT_MARKERS = (
    ...
    "CRM logistics exact: \"We collect that during scoping if you move forward.\" No contact invention, mockup, or email CTA.",
    ...
    "Never mention mockup, send, email, or renewed pitch.",
    "Return only after clear topic change or buyer mockup acceptance/request.",
    "Never read the menu.",
