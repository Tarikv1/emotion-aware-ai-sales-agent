...
REQUIRED_DIRS = [
    ...
    ("dir.runtime", "runtime", "Runtime boundary directory"),
    ("dir.docs_product", "docs/product", "Product documentation"),
    ("dir.docs_brain", "docs/brain", "Brain documentation"),
    ...
    ("dir.data_external", "data/external", "Ignored external dataset workspace"),
...
REQUIRED_FILES = [
    ...
    ("file.runtime_readme", "runtime/README.md", "Runtime boundary guide"),
    ("file.runtime_manifest", "runtime/runtime_manifest.json", "Runtime boundary manifest"),
    ...
    ("file.docs_product_full_sale_mvp_strategy", "docs/product/FULL_SALE_MVP_STRATEGY.md", "Full-sale MVP strategy"),
    ("file.docs_product_prod_007_full_call_gauntlet", "docs/product/PROD_007_FULL_CALL_GAUNTLET.md", "PROD-007 full-call gauntlet"),
    ("file.docs_product_prod_008_generated_full_call_packets", "docs/product/PROD_008_GENERATED_FULL_CALL_PACKETS.md", "PROD-008 generated full-call packets"),
    ("file.docs_product_prod_009_cross_domain_generated_gauntlet", "docs/product/PROD_009_CROSS_DOMAIN_GENERATED_GAUNTLET.md", "PROD-009 cross-domain generated gauntlet"),
    ("file.docs_product_prod_010_long_call_universal_objections", "docs/product/PROD_010_LONG_CALL_UNIVERSAL_OBJECTIONS.md", "PROD-010 long-call universal objections"),
    ("file.docs_product_prod_012_callcenteren_scenario_evaluation", "docs/product/PROD_012_CALLCENTEREN_SCENARIO_EVALUATION.md", "PROD-012 CallCenterEN scenario evaluation"),
    ("file.docs_product_prod_013_callcenteren_pattern_extraction", "docs/product/PROD_013_CALLCENTEREN_PATTERN_EXTRACTION.md", "PROD-013 CallCenterEN pattern extraction"),
    ("file.docs_product_prod_014_callcenteren_scenario_bank", "docs/product/PROD_014_CALLCENTEREN_SCENARIO_BANK.md", "PROD-014 CallCenterEN scenario bank"),
    ("file.docs_product_prod_015_callcenteren_runtime_comparison", "docs/product/PROD_015_CALLCENTEREN_RUNTIME_COMPARISON.md", "PROD-015 CallCenterEN runtime comparison"),
    ("file.docs_product_prod_016_callcenteren_retrieval_no_gain_diagnosis", "docs/product/PROD_016_CALLCENTEREN_RETRIEVAL_NO_GAIN_DIAGNOSIS.md", "PROD-016 CallCenterEN retrieval no-gain diagnosis"),
    ("file.docs_product_prod_017_callcenteren_specificity_scoring", "docs/product/PROD_017_CALLCENTEREN_SPECIFICITY_SCORING.md", "PROD-017 CallCenterEN specificity scoring"),
    ("file.docs_product_prod_018_callcenteren_composer_hook_test", "docs/product/PROD_018_CALLCENTEREN_COMPOSER_HOOK_TEST.md", "PROD-018 CallCenterEN composer hook test"),
    ("file.docs_product_prod_019_guarded_runtime_composer_hooks", "docs/product/PROD_019_GUARDED_RUNTIME_COMPOSER_HOOKS.md", "PROD-019 guarded runtime composer hooks"),
    ("file.docs_product_prod_020_naturalized_customer_turn_evaluation", "docs/product/PROD_020_NATURALIZED_CUSTOMER_TURN_EVALUATION.md", "PROD-020 naturalized customer-turn evaluation"),
    ("file.docs_product_prod_021_live_shaped_dialogue_policy_simulation", "docs/product/PROD_021_LIVE_SHAPED_DIALOGUE_POLICY_SIMULATION.md", "PROD-021 live-shaped dialogue-policy simulation"),
    ("file.docs_product_prod_022_prod_021_review_gap_packet", "docs/product/PROD_022_PROD_021_REVIEW_GAP_PACKET.md", "PROD-022 PROD-021 review gap packet"),
    ("file.docs_product_prod_023_runtime_policy_call_control_fix", "docs/product/PROD_023_RUNTIME_POLICY_CALL_CONTROL_FIX.md", "PROD-023 runtime-policy call-control fix"),
    ("file.docs_product_prod_024_live_shaped_post_fix_rerun", "docs/product/PROD_024_LIVE_SHAPED_POST_FIX_RERUN.md", "PROD-024 live-shaped post-fix rerun"),
    ("file.docs_product_prod_025_bounded_demo_readiness_packet", "docs/product/PROD_025_BOUNDED_DEMO_READINESS_PACKET.md", "PROD-025 bounded demo readiness packet"),
    ("file.docs_product_prod_026_local_demo_trace_harness", "docs/product/PROD_026_LOCAL_DEMO_TRACE_HARNESS.md", "PROD-026 local demo trace harness"),
    ("file.docs_product_prod_027_full_scenario_route_evaluation", "docs/product/PROD_027_FULL_SCENARIO_ROUTE_EVALUATION.md", "PROD-027 full scenario route evaluation"),
    ("file.docs_product_prod_028_synthetic_campaign_knowledge_grounding", "docs/product/PROD_028_SYNTHETIC_CAMPAIGN_KNOWLEDGE_GROUNDING.md", "PROD-028 synthetic campaign knowledge grounding"),
    ("file.docs_product_prod_029_grounded_full_scenario_rerun", "docs/product/PROD_029_GROUNDED_FULL_SCENARIO_RERUN.md", "PROD-029 grounded full scenario rerun"),
    ("file.docs_product_prod_030_grounded_demo_review", "docs/product/PROD_030_GROUNDED_DEMO_REVIEW.md", "PROD-030 grounded demo review"),
    ...
    ("file.docs_product_prod_032_interactive_simulation_review", "docs/product/PROD_032_INTERACTIVE_SIMULATION_REVIEW.md", "PROD-032 interactive simulation review"),
    ("file.docs_product_prod_033_interactive_simulator_termination_fix", "docs/product/PROD_033_INTERACTIVE_SIMULATOR_TERMINATION_FIX.md", "PROD-033 interactive simulator termination fix"),
    ("file.docs_product_prod_034_interactive_post_fix_review", "docs/product/PROD_034_INTERACTIVE_POST_FIX_REVIEW.md", "PROD-034 interactive post-fix review"),
    ("file.docs_product_prod_035_runtime_decision_trace_alignment", "docs/product/PROD_035_RUNTIME_DECISION_TRACE_ALIGNMENT.md", "PROD-035 runtime decision-trace alignment"),
    ("file.docs_product_prod_036_interactive_demo_readiness_review", "docs/product/PROD_036_INTERACTIVE_DEMO_READINESS_REVIEW.md", "PROD-036 interactive demo readiness review"),
    ("file.docs_product_prod_037_local_interactive_trace_demo_surface", "docs/product/PROD_037_LOCAL_INTERACTIVE_TRACE_DEMO_SURFACE.md", "PROD-037 local interactive trace demo surface"),
    ("file.docs_product_prod_038_local_demo_surface_review", "docs/product/PROD_038_LOCAL_DEMO_SURFACE_REVIEW.md", "PROD-038 local demo surface review"),
    ("file.docs_product_prod_039_customer_realism_simulator_hardening", "docs/product/PROD_039_CUSTOMER_REALISM_SIMULATOR_HARDENING.md", "PROD-039 customer realism simulator hardening"),
    ("file.docs_product_prod_040_callcenteren_conditional_customer_simulation", "docs/product/PROD_040_CALLCENTEREN_CONDITIONAL_CUSTOMER_SIMULATION.md", "PROD-040 CallCenterEN conditional customer simulation"),
    ("file.docs_product_prod_041a_conditional_scenario_diversity_expansion", "docs/product/PROD_041A_CONDITIONAL_SCENARIO_DIVERSITY_EXPANSION.md", "PROD-041A conditional scenario diversity expansion"),
    ("file.docs_product_prod_041_conditional_simulation_review", "docs/product/PROD_041_CONDITIONAL_SIMULATION_REVIEW.md", "PROD-041 conditional simulation review"),
    ("file.docs_project_navigation", "docs/PROJECT_NAVIGATION.md", "Project navigation map"),
    ("file.docs_brain_readme", "docs/brain/README.md", "Brain folder README"),
    ("file.docs_product_checkpoint_index", "docs/product/CHECKPOINT_INDEX.md", "Product checkpoint index"),
    ("file.docs_product_english_multi_turn_regression_guard", "docs/product/ENGLISH_MULTI_TURN_REGRESSION_GUARD.md", "English multi-turn regression guard"),
    ("file.docs_brain_prod_011_dialogue_policy_hardening", "docs/brain/PROD_011_DIALOGUE_POLICY_HARDENING.md", "PROD-011 dialogue-policy hardening"),
    ("file.docs_brain_brain_001_project_brain_architecture", "docs/brain/BRAIN_001_PROJECT_BRAIN_ARCHITECTURE.md", "BRAIN-001 project brain architecture"),
    ("file.docs_brain_brain_002_runtime_state_schema", "docs/brain/BRAIN_002_RUNTIME_STATE_SCHEMA.md", "BRAIN-002 runtime state schema"),
    ...
    ("file.docs_product_rag_020_sales_persuasion_emotion_deep_dive", "docs/product/RAG_020_SALES_PERSUASION_EMOTION_DEEP_DIVE.md", "RAG sales persuasion emotion deep dive"),
    ("file.docs_product_rag_021_buyer_trust_conversation_repair", "docs/product/RAG_021_BUYER_TRUST_CONVERSATION_REPAIR.md", "RAG buyer trust conversation repair"),
    ("file.docs_product_resp_007_german_pacing_stability", "docs/product/RESP_007_GERMAN_PACING_STABILITY_FOLLOW_UP.md", "RESP-007 German pacing stability follow-up"),
    ("file.runtime_voice_provider_run_boundary", "runtime/providers/VOICE_PROVIDER_RUN_BOUNDARY.md", "Voice provider run boundary"),
    ("file.runtime_voice_generated_audio_asset_log", "runtime/providers/VOICE_GENERATED_AUDIO_ASSET_LOG.md", "Voice generated audio asset log"),
    ("file.runtime_realtime_agent_architecture", "runtime/architecture/REALTIME_AGENT_ARCHITECTURE.md", "Realtime architecture"),
    ("file.runtime_realtime_turn_cli_doc", "runtime/entrypoints/REALTIME_TURN_CLI.md", "Realtime CLI docs"),
    ("file.runtime_call_termination_policy", "runtime/policy/CALL_TERMINATION_POLICY.md", "Runtime call termination policy"),
    ("file.runtime_bilingual_realtime_core", "runtime/policy/BILINGUAL_REALTIME_CORE.md", "Runtime bilingual realtime policy"),
    ("file.runtime_sqlite_prototype_doc", "runtime/persistence/SQLITE_PROTOTYPE.md", "Runtime SQLite prototype doc"),
    ...
    ("file.docs_product_voice_041_private_pattern_profile", "docs/product/VOICE_041_PRIVATE_PATTERN_PROFILE.md", "Voice private pattern profile"),
    ("file.docs_product_voice_042_private_pattern_live_ab", "docs/product/VOICE_042_PRIVATE_PATTERN_LIVE_AB.md", "Voice private pattern live A/B"),
    ("file.docs_product_voice_043_baseline_shaped_runtime", "docs/product/VOICE_043_BASELINE_SHAPED_RUNTIME_ACCEPTANCE.md", "Voice baseline shaped runtime acceptance"),
    ("file.docs_product_voice_044_baseline_delivery_polish", "docs/product/VOICE_044_BASELINE_DELIVERY_POLISH.md", "Voice baseline delivery polish"),
    ...
    ("file.docs_product_resp_004_voice_044_listening_check", "docs/product/RESP_004_VOICE_044_LISTENING_CHECK.md", "RESP-004 VOICE-044 listening check"),
    ...
    ("file.data_external_gitignore", "data/external/.gitignore", "External dataset local ignore rule"),
    ("file.config_local_gitignore", "config/local/.gitignore", "Local config ignore rule"),
    ("file.config_local_voice_ids_example", "runtime/config/local/voice_ids.example.json", "Runtime local voice ID config example"),
    ...
    ("file.scripts_validate_brain_001_project_brain_architecture", "scripts/validate_brain_001_project_brain_architecture.py", "BRAIN-001 architecture validator"),
    ("file.scripts_brain_runtime_state_schema", "scripts/brain_runtime_state_schema.py", "BRAIN-002 runtime state schema module"),
    ("file.scripts_run_brain_002_runtime_state_schema", "scripts/run_brain_002_runtime_state_schema.py", "BRAIN-002 runtime state schema runner"),
    ("file.scripts_validate_brain_002_runtime_state_schema", "scripts/validate_brain_002_runtime_state_schema.py", "BRAIN-002 runtime state schema validator"),
    ...
    ("file.scripts_validate_english_multi_turn_regression_guard", "scripts/validate_english_multi_turn_regression_guard.py", "English multi-turn regression guard validator"),
    ...
    ("file.scripts_rag_sales_persuasion_emotion_deep_dive", "scripts/rag_sales_persuasion_emotion_deep_dive.py", "RAG sales persuasion emotion deep dive module"),
    ("file.scripts_rag_buyer_trust_conversation_repair", "scripts/rag_buyer_trust_conversation_repair.py", "RAG buyer trust conversation repair module"),
    ...
    ("file.scripts_run_rag_018_scripted_call_simulation", "scripts/run_rag_018_scripted_call_simulation.py", "RAG scripted call simulation runner"),
    ...
    ("file.scripts_validate_rag_018_scripted_call_simulation", "scripts/validate_rag_018_scripted_call_simulation.py", "RAG scripted call simulation validator"),
    ...
    ("file.scripts_run_rag_020_sales_persuasion_emotion_deep_dive", "scripts/run_rag_020_sales_persuasion_emotion_deep_dive.py", "RAG sales persuasion emotion deep dive runner"),
    ("file.scripts_validate_rag_020_sales_persuasion_emotion_deep_dive", "scripts/validate_rag_020_sales_persuasion_emotion_deep_dive.py", "RAG sales persuasion emotion deep dive validator"),
    ("file.scripts_run_rag_021_buyer_trust_conversation_repair", "scripts/run_rag_021_buyer_trust_conversation_repair.py", "RAG buyer trust conversation repair runner"),
    ("file.scripts_validate_rag_021_buyer_trust_conversation_repair", "scripts/validate_rag_021_buyer_trust_conversation_repair.py", "RAG buyer trust conversation repair validator"),
    ("file.scripts_full_sale_scenario_grounding", "scripts/full_sale_scenario_grounding.py", "Full-sale scenario grounding module"),
    ("file.scripts_run_prod_006_full_sale_scenario_grounding", "scripts/run_prod_006_full_sale_scenario_grounding.py", "PROD-006 full-sale scenario grounding runner"),
    ("file.scripts_validate_prod_006_full_sale_scenario_grounding", "scripts/validate_prod_006_full_sale_scenario_grounding.py", "PROD-006 full-sale scenario grounding validator"),
    ("file.scripts_full_call_gauntlet", "scripts/full_call_gauntlet.py", "Full-call gauntlet module"),
    ("file.scripts_run_prod_007_full_call_gauntlet", "scripts/run_prod_007_full_call_gauntlet.py", "PROD-007 full-call gauntlet runner"),
    ("file.scripts_validate_prod_007_full_call_gauntlet", "scripts/validate_prod_007_full_call_gauntlet.py", "PROD-007 full-call gauntlet validator"),
    ("file.scripts_generated_full_call_packets", "scripts/generated_full_call_packets.py", "Generated full-call packet module"),
    ("file.scripts_run_prod_008_generated_full_call_packets", "scripts/run_prod_008_generated_full_call_packets.py", "PROD-008 generated full-call packet runner"),
    ("file.scripts_validate_prod_008_generated_full_call_packets", "scripts/validate_prod_008_generated_full_call_packets.py", "PROD-008 generated full-call packet validator"),
    ("file.scripts_run_prod_009_cross_domain_generated_gauntlet", "scripts/run_prod_009_cross_domain_generated_gauntlet.py", "PROD-009 cross-domain generated gauntlet runner"),
    ("file.scripts_validate_prod_009_cross_domain_generated_gauntlet", "scripts/validate_prod_009_cross_domain_generated_gauntlet.py", "PROD-009 cross-domain generated gauntlet validator"),
    ("file.scripts_run_prod_010_long_call_universal_objections", "scripts/run_prod_010_long_call_universal_objections.py", "PROD-010 long-call universal-objection runner"),
    ("file.scripts_validate_prod_010_long_call_universal_objections", "scripts/validate_prod_010_long_call_universal_objections.py", "PROD-010 long-call universal-objection validator"),
    ("file.scripts_dialogue_policy_hardening", "scripts/dialogue_policy_hardening.py", "PROD-011 dialogue-policy hardening module"),
    ("file.scripts_run_prod_011_dialogue_policy_hardening", "scripts/run_prod_011_dialogue_policy_hardening.py", "PROD-011 dialogue-policy hardening runner"),
    ("file.scripts_validate_prod_011_dialogue_policy_hardening", "scripts/validate_prod_011_dialogue_policy_hardening.py", "PROD-011 dialogue-policy hardening validator"),
    ("file.scripts_callcenteren_scenario_evaluation", "scripts/callcenteren_scenario_evaluation.py", "CallCenterEN scenario evaluation module"),
    ("file.scripts_run_prod_012_callcenteren_scenario_evaluation", "scripts/run_prod_012_callcenteren_scenario_evaluation.py", "PROD-012 CallCenterEN scenario evaluation runner"),
    ("file.scripts_validate_prod_012_callcenteren_scenario_evaluation", "scripts/validate_prod_012_callcenteren_scenario_evaluation.py", "PROD-012 CallCenterEN scenario evaluation validator"),
    ("file.scripts_callcenteren_pattern_extraction", "scripts/callcenteren_pattern_extraction.py", "CallCenterEN pattern extraction module"),
    ("file.scripts_run_prod_013_callcenteren_pattern_extraction", "scripts/run_prod_013_callcenteren_pattern_extraction.py", "PROD-013 CallCenterEN pattern extraction runner"),
    ("file.scripts_validate_prod_013_callcenteren_pattern_extraction", "scripts/validate_prod_013_callcenteren_pattern_extraction.py", "PROD-013 CallCenterEN pattern extraction validator"),
    ("file.scripts_callcenteren_scenario_bank", "scripts/callcenteren_scenario_bank.py", "CallCenterEN scenario-bank module"),
    ("file.scripts_run_prod_014_callcenteren_scenario_bank", "scripts/run_prod_014_callcenteren_scenario_bank.py", "PROD-014 CallCenterEN scenario-bank runner"),
    ("file.scripts_validate_prod_014_callcenteren_scenario_bank", "scripts/validate_prod_014_callcenteren_scenario_bank.py", "PROD-014 CallCenterEN scenario-bank validator"),
    ("file.scripts_callcenteren_runtime_comparison", "scripts/callcenteren_runtime_comparison.py", "CallCenterEN runtime-comparison module"),
    ("file.scripts_run_prod_015_callcenteren_runtime_comparison", "scripts/run_prod_015_callcenteren_runtime_comparison.py", "PROD-015 CallCenterEN runtime-comparison runner"),
    ("file.scripts_validate_prod_015_callcenteren_runtime_comparison", "scripts/validate_prod_015_callcenteren_runtime_comparison.py", "PROD-015 CallCenterEN runtime-comparison validator"),
    ("file.scripts_callcenteren_retrieval_no_gain_diagnosis", "scripts/callcenteren_retrieval_no_gain_diagnosis.py", "CallCenterEN retrieval no-gain diagnosis module"),
    ("file.scripts_run_prod_016_callcenteren_retrieval_no_gain_diagnosis", "scripts/run_prod_016_callcenteren_retrieval_no_gain_diagnosis.py", "PROD-016 CallCenterEN retrieval no-gain diagnosis runner"),
    ("file.scripts_validate_prod_016_callcenteren_retrieval_no_gain_diagnosis", "scripts/validate_prod_016_callcenteren_retrieval_no_gain_diagnosis.py", "PROD-016 CallCenterEN retrieval no-gain diagnosis validator"),
    ("file.scripts_callcenteren_specificity_scoring", "scripts/callcenteren_specificity_scoring.py", "CallCenterEN specificity scoring module"),
    ("file.scripts_run_prod_017_callcenteren_specificity_scoring", "scripts/run_prod_017_callcenteren_specificity_scoring.py", "PROD-017 CallCenterEN specificity scoring runner"),
    ("file.scripts_validate_prod_017_callcenteren_specificity_scoring", "scripts/validate_prod_017_callcenteren_specificity_scoring.py", "PROD-017 CallCenterEN specificity scoring validator"),
    ("file.scripts_callcenteren_composer_hook_test", "scripts/callcenteren_composer_hook_test.py", "CallCenterEN composer-hook test module"),
    ("file.scripts_run_prod_018_callcenteren_composer_hook_test", "scripts/run_prod_018_callcenteren_composer_hook_test.py", "PROD-018 CallCenterEN composer-hook test runner"),
    ("file.scripts_validate_prod_018_callcenteren_composer_hook_test", "scripts/validate_prod_018_callcenteren_composer_hook_test.py", "PROD-018 CallCenterEN composer-hook test validator"),
    ("file.scripts_runtime_composer_hooks", "scripts/runtime_composer_hooks.py", "Runtime composer hook helper"),
    ("file.scripts_prod_019_guarded_runtime_composer_hooks", "scripts/prod_019_guarded_runtime_composer_hooks.py", "PROD-019 guarded runtime composer hooks module"),
    ("file.scripts_run_prod_019_guarded_runtime_composer_hooks", "scripts/run_prod_019_guarded_runtime_composer_hooks.py", "PROD-019 guarded runtime composer hooks runner"),
    ("file.scripts_validate_prod_019_guarded_runtime_composer_hooks", "scripts/validate_prod_019_guarded_runtime_composer_hooks.py", "PROD-019 guarded runtime composer hooks validator"),
    ("file.scripts_prod_020_naturalized_customer_turn_evaluation", "scripts/prod_020_naturalized_customer_turn_evaluation.py", "PROD-020 naturalized customer-turn evaluation module"),
    ("file.scripts_run_prod_020_naturalized_customer_turn_evaluation", "scripts/run_prod_020_naturalized_customer_turn_evaluation.py", "PROD-020 naturalized customer-turn evaluation runner"),
    ("file.scripts_validate_prod_020_naturalized_customer_turn_evaluation", "scripts/validate_prod_020_naturalized_customer_turn_evaluation.py", "PROD-020 naturalized customer-turn evaluation validator"),
    ("file.scripts_prod_021_live_shaped_dialogue_policy_simulation", "scripts/prod_021_live_shaped_dialogue_policy_simulation.py", "PROD-021 live-shaped dialogue-policy simulation module"),
    ("file.scripts_run_prod_021_live_shaped_dialogue_policy_simulation", "scripts/run_prod_021_live_shaped_dialogue_policy_simulation.py", "PROD-021 live-shaped dialogue-policy simulation runner"),
    ("file.scripts_validate_prod_021_live_shaped_dialogue_policy_simulation", "scripts/validate_prod_021_live_shaped_dialogue_policy_simulation.py", "PROD-021 live-shaped dialogue-policy simulation validator"),
    ("file.scripts_prod_022_prod_021_review_gap_packet", "scripts/prod_022_prod_021_review_gap_packet.py", "PROD-022 PROD-021 review gap packet module"),
    ("file.scripts_run_prod_022_prod_021_review_gap_packet", "scripts/run_prod_022_prod_021_review_gap_packet.py", "PROD-022 PROD-021 review gap packet runner"),
    ("file.scripts_validate_prod_022_prod_021_review_gap_packet", "scripts/validate_prod_022_prod_021_review_gap_packet.py", "PROD-022 PROD-021 review gap packet validator"),
    ("file.scripts_prod_023_runtime_policy_call_control_fix", "scripts/prod_023_runtime_policy_call_control_fix.py", "PROD-023 runtime-policy call-control fix module"),
    ("file.scripts_run_prod_023_runtime_policy_call_control_fix", "scripts/run_prod_023_runtime_policy_call_control_fix.py", "PROD-023 runtime-policy call-control fix runner"),
    ("file.scripts_validate_prod_023_runtime_policy_call_control_fix", "scripts/validate_prod_023_runtime_policy_call_control_fix.py", "PROD-023 runtime-policy call-control fix validator"),
    ("file.scripts_prod_024_live_shaped_post_fix_rerun", "scripts/prod_024_live_shaped_post_fix_rerun.py", "PROD-024 live-shaped post-fix rerun module"),
    ("file.scripts_run_prod_024_live_shaped_post_fix_rerun", "scripts/run_prod_024_live_shaped_post_fix_rerun.py", "PROD-024 live-shaped post-fix rerun runner"),
    ("file.scripts_validate_prod_024_live_shaped_post_fix_rerun", "scripts/validate_prod_024_live_shaped_post_fix_rerun.py", "PROD-024 live-shaped post-fix rerun validator"),
    ("file.scripts_prod_025_bounded_demo_readiness_packet", "scripts/prod_025_bounded_demo_readiness_packet.py", "PROD-025 bounded demo readiness packet module"),
    ("file.scripts_run_prod_025_bounded_demo_readiness_packet", "scripts/run_prod_025_bounded_demo_readiness_packet.py", "PROD-025 bounded demo readiness packet runner"),
    ("file.scripts_validate_prod_025_bounded_demo_readiness_packet", "scripts/validate_prod_025_bounded_demo_readiness_packet.py", "PROD-025 bounded demo readiness packet validator"),
    ("file.scripts_prod_026_local_demo_trace_harness", "scripts/prod_026_local_demo_trace_harness.py", "PROD-026 local demo trace harness module"),
    ("file.scripts_run_prod_026_local_demo_trace_harness", "scripts/run_prod_026_local_demo_trace_harness.py", "PROD-026 local demo trace harness runner"),
    ("file.scripts_validate_prod_026_local_demo_trace_harness", "scripts/validate_prod_026_local_demo_trace_harness.py", "PROD-026 local demo trace harness validator"),
    ("file.scripts_prod_027_full_scenario_route_evaluation", "scripts/prod_027_full_scenario_route_evaluation.py", "PROD-027 full scenario route evaluation module"),
    ("file.scripts_run_prod_027_full_scenario_route_evaluation", "scripts/run_prod_027_full_scenario_route_evaluation.py", "PROD-027 full scenario route evaluation runner"),
    ("file.scripts_validate_prod_027_full_scenario_route_evaluation", "scripts/validate_prod_027_full_scenario_route_evaluation.py", "PROD-027 full scenario route evaluation validator"),
    ("file.scripts_prod_028_synthetic_campaign_knowledge_grounding", "scripts/prod_028_synthetic_campaign_knowledge_grounding.py", "PROD-028 synthetic campaign knowledge grounding module"),
    ("file.scripts_run_prod_028_synthetic_campaign_knowledge_grounding", "scripts/run_prod_028_synthetic_campaign_knowledge_grounding.py", "PROD-028 synthetic campaign knowledge grounding runner"),
    ("file.scripts_validate_prod_028_synthetic_campaign_knowledge_grounding", "scripts/validate_prod_028_synthetic_campaign_knowledge_grounding.py", "PROD-028 synthetic campaign knowledge grounding validator"),
    ("file.scripts_prod_029_grounded_full_scenario_rerun", "scripts/prod_029_grounded_full_scenario_rerun.py", "PROD-029 grounded full scenario rerun module"),
    ("file.scripts_run_prod_029_grounded_full_scenario_rerun", "scripts/run_prod_029_grounded_full_scenario_rerun.py", "PROD-029 grounded full scenario rerun runner"),
    ("file.scripts_validate_prod_029_grounded_full_scenario_rerun", "scripts/validate_prod_029_grounded_full_scenario_rerun.py", "PROD-029 grounded full scenario rerun validator"),
    ("file.scripts_prod_030_grounded_demo_review", "scripts/prod_030_grounded_demo_review.py", "PROD-030 grounded demo review module"),
    ("file.scripts_run_prod_030_grounded_demo_review", "scripts/run_prod_030_grounded_demo_review.py", "PROD-030 grounded demo review runner"),
    ("file.scripts_validate_prod_030_grounded_demo_review", "scripts/validate_prod_030_grounded_demo_review.py", "PROD-030 grounded demo review validator"),
    ...
    ("file.scripts_prod_032_interactive_simulation_review", "scripts/prod_032_interactive_simulation_review.py", "PROD-032 interactive simulation review module"),
    ("file.scripts_run_prod_032_interactive_simulation_review", "scripts/run_prod_032_interactive_simulation_review.py", "PROD-032 interactive simulation review runner"),
    ("file.scripts_validate_prod_032_interactive_simulation_review", "scripts/validate_prod_032_interactive_simulation_review.py", "PROD-032 interactive simulation review validator"),
    ("file.scripts_prod_033_interactive_simulator_termination_fix", "scripts/prod_033_interactive_simulator_termination_fix.py", "PROD-033 interactive simulator termination fix module"),
    ("file.scripts_run_prod_033_interactive_simulator_termination_fix", "scripts/run_prod_033_interactive_simulator_termination_fix.py", "PROD-033 interactive simulator termination fix runner"),
    ("file.scripts_validate_prod_033_interactive_simulator_termination_fix", "scripts/validate_prod_033_interactive_simulator_termination_fix.py", "PROD-033 interactive simulator termination fix validator"),
    ("file.scripts_prod_034_interactive_post_fix_review", "scripts/prod_034_interactive_post_fix_review.py", "PROD-034 interactive post-fix review module"),
    ("file.scripts_run_prod_034_interactive_post_fix_review", "scripts/run_prod_034_interactive_post_fix_review.py", "PROD-034 interactive post-fix review runner"),
    ("file.scripts_validate_prod_034_interactive_post_fix_review", "scripts/validate_prod_034_interactive_post_fix_review.py", "PROD-034 interactive post-fix review validator"),
    ("file.scripts_prod_035_runtime_decision_trace_alignment", "scripts/prod_035_runtime_decision_trace_alignment.py", "PROD-035 runtime decision-trace alignment module"),
    ("file.scripts_run_prod_035_runtime_decision_trace_alignment", "scripts/run_prod_035_runtime_decision_trace_alignment.py", "PROD-035 runtime decision-trace alignment runner"),
    ("file.scripts_validate_prod_035_runtime_decision_trace_alignment", "scripts/validate_prod_035_runtime_decision_trace_alignment.py", "PROD-035 runtime decision-trace alignment validator"),
    ("file.scripts_prod_036_interactive_demo_readiness_review", "scripts/prod_036_interactive_demo_readiness_review.py", "PROD-036 interactive demo readiness review module"),
    ("file.scripts_run_prod_036_interactive_demo_readiness_review", "scripts/run_prod_036_interactive_demo_readiness_review.py", "PROD-036 interactive demo readiness review runner"),
    ("file.scripts_validate_prod_036_interactive_demo_readiness_review", "scripts/validate_prod_036_interactive_demo_readiness_review.py", "PROD-036 interactive demo readiness review validator"),
    ("file.scripts_prod_037_local_interactive_trace_demo_surface", "scripts/prod_037_local_interactive_trace_demo_surface.py", "PROD-037 local interactive trace demo surface module"),
    ("file.scripts_run_prod_037_local_interactive_trace_demo_surface", "scripts/run_prod_037_local_interactive_trace_demo_surface.py", "PROD-037 local interactive trace demo surface runner"),
    ("file.scripts_validate_prod_037_local_interactive_trace_demo_surface", "scripts/validate_prod_037_local_interactive_trace_demo_surface.py", "PROD-037 local interactive trace demo surface validator"),
    ("file.scripts_prod_038_local_demo_surface_review", "scripts/prod_038_local_demo_surface_review.py", "PROD-038 local demo surface review module"),
    ("file.scripts_run_prod_038_local_demo_surface_review", "scripts/run_prod_038_local_demo_surface_review.py", "PROD-038 local demo surface review runner"),
    ("file.scripts_validate_prod_038_local_demo_surface_review", "scripts/validate_prod_038_local_demo_surface_review.py", "PROD-038 local demo surface review validator"),
    ("file.scripts_prod_039_customer_realism_simulator_hardening", "scripts/prod_039_customer_realism_simulator_hardening.py", "PROD-039 customer realism simulator hardening module"),
    ("file.scripts_run_prod_039_customer_realism_simulator_hardening", "scripts/run_prod_039_customer_realism_simulator_hardening.py", "PROD-039 customer realism simulator hardening runner"),
    ("file.scripts_validate_prod_039_customer_realism_simulator_hardening", "scripts/validate_prod_039_customer_realism_simulator_hardening.py", "PROD-039 customer realism simulator hardening validator"),
    ("file.scripts_prod_040_callcenteren_conditional_customer_simulation", "scripts/prod_040_callcenteren_conditional_customer_simulation.py", "PROD-040 CallCenterEN conditional customer simulation module"),
    ("file.scripts_run_prod_040_callcenteren_conditional_customer_simulation", "scripts/run_prod_040_callcenteren_conditional_customer_simulation.py", "PROD-040 CallCenterEN conditional customer simulation runner"),
    ("file.scripts_validate_prod_040_callcenteren_conditional_customer_simulation", "scripts/validate_prod_040_callcenteren_conditional_customer_simulation.py", "PROD-040 CallCenterEN conditional customer simulation validator"),
    ("file.scripts_prod_041a_conditional_scenario_diversity_expansion", "scripts/prod_041a_conditional_scenario_diversity_expansion.py", "PROD-041A conditional scenario diversity expansion module"),
    ("file.scripts_run_prod_041a_conditional_scenario_diversity_expansion", "scripts/run_prod_041a_conditional_scenario_diversity_expansion.py", "PROD-041A conditional scenario diversity expansion runner"),
    ("file.scripts_validate_prod_041a_conditional_scenario_diversity_expansion", "scripts/validate_prod_041a_conditional_scenario_diversity_expansion.py", "PROD-041A conditional scenario diversity expansion validator"),
    ("file.scripts_prod_041_conditional_simulation_review", "scripts/prod_041_conditional_simulation_review.py", "PROD-041 conditional simulation review module"),
    ("file.scripts_run_prod_041_conditional_simulation_review", "scripts/run_prod_041_conditional_simulation_review.py", "PROD-041 conditional simulation review runner"),
    ("file.scripts_validate_prod_041_conditional_simulation_review", "scripts/validate_prod_041_conditional_simulation_review.py", "PROD-041 conditional simulation review validator"),
    ...
    ("file.scripts_voice_private_pattern_profile", "scripts/voice_private_pattern_profile.py", "Voice private pattern profile module"),
    ("file.scripts_run_voice_041_private_pattern_profile", "scripts/run_voice_041_private_pattern_profile.py", "Voice private pattern profile runner"),
    ("file.scripts_validate_voice_041_private_pattern_profile", "scripts/validate_voice_041_private_pattern_profile.py", "Voice private pattern profile validator"),
    ("file.scripts_run_voice_042_private_pattern_live_ab", "scripts/run_voice_042_private_pattern_live_ab.py", "Voice private pattern live A/B runner"),
    ("file.scripts_validate_voice_042_private_pattern_live_ab", "scripts/validate_voice_042_private_pattern_live_ab.py", "Voice private pattern live A/B validator"),
    ("file.scripts_run_voice_043_baseline_shaped_runtime", "scripts/run_voice_043_baseline_shaped_runtime_acceptance.py", "Voice baseline shaped runtime acceptance runner"),
    ("file.scripts_validate_voice_043_baseline_shaped_runtime", "scripts/validate_voice_043_baseline_shaped_runtime_acceptance.py", "Voice baseline shaped runtime acceptance validator"),
    ("file.scripts_voice_baseline_delivery_polish", "scripts/voice_baseline_delivery_polish.py", "Voice baseline delivery polish module"),
    ("file.scripts_run_voice_044_baseline_delivery_polish", "scripts/run_voice_044_baseline_delivery_polish.py", "Voice baseline delivery polish runner"),
    ("file.scripts_validate_voice_044_baseline_delivery_polish", "scripts/validate_voice_044_baseline_delivery_polish.py", "Voice baseline delivery polish validator"),
    ...
    ("file.scripts_run_resp_004_voice_044_listening_check", "scripts/run_resp_004_voice_044_listening_check.py", "RESP-004 VOICE-044 listening check runner"),
    ("file.scripts_validate_resp_004_voice_044_listening_check", "scripts/validate_resp_004_voice_044_listening_check.py", "RESP-004 VOICE-044 listening check validator"),
    ...
    ("file.scripts_run_resp_007_german_pacing_stability", "scripts/run_resp_007_german_pacing_stability_follow_up.py", "RESP-007 German pacing stability runner"),
    ("file.scripts_validate_resp_007_german_pacing_stability", "scripts/validate_resp_007_german_pacing_stability_follow_up.py", "RESP-007 German pacing stability validator"),
    ("file.data_rag_readme", "data/rag/README.md", "RAG data workspace README"),
    ("file.research_experiments_readme", "research/experiments/README.md", "Experiment folder README"),
    ("file.scripts_readme", "scripts/README.md", "Scripts folder README"),
    ...
    ("file.research_case_rag_018_scripted_call_simulation", "research/experiments/cases/rag-018-scripted-call-simulation.json", "RAG scripted call simulation case file"),
    ...
    ("file.research_case_rag_020_sales_persuasion_emotion_deep_dive", "research/experiments/cases/rag-020-sales-persuasion-emotion-deep-dive.json", "RAG sales persuasion emotion deep dive case file"),
    ("file.research_case_rag_021_buyer_trust_conversation_repair", "research/experiments/cases/rag-021-buyer-trust-conversation-repair.json", "RAG buyer trust conversation repair case file"),
    ("file.research_case_brain_002_runtime_state_schema", "research/experiments/cases/brain-002-runtime-state-schema.json", "BRAIN-002 runtime state schema case file"),
    ("file.research_case_prod_006_full_sale_scenario_grounding", "research/experiments/cases/prod-006-full-sale-scenario-grounding.json", "PROD-006 full-sale scenario grounding case file"),
    ("file.research_case_prod_007_full_call_gauntlet", "research/experiments/cases/prod-007-full-call-gauntlet.json", "PROD-007 full-call gauntlet case file"),
    ("file.research_case_prod_008_generated_full_call_packets", "research/experiments/cases/prod-008-generated-full-call-packets.json", "PROD-008 generated full-call packet case file"),
    ("file.research_case_prod_009_cross_domain_generated_gauntlet", "research/experiments/cases/prod-009-cross-domain-generated-gauntlet.json", "PROD-009 cross-domain generated gauntlet case file"),
    ("file.research_case_prod_010_long_call_universal_objections", "research/experiments/cases/prod-010-long-call-universal-objections.json", "PROD-010 long-call universal-objection case file"),
    ("file.research_case_prod_011_dialogue_policy_hardening", "research/experiments/cases/prod-011-dialogue-policy-hardening.json", "PROD-011 dialogue-policy hardening case file"),
    ("file.research_case_prod_012_callcenteren_scenario_evaluation", "research/experiments/cases/prod-012-callcenteren-scenario-evaluation.json", "PROD-012 CallCenterEN scenario evaluation case file"),
    ("file.research_case_resp_007_german_pacing_stability", "research/experiments/cases/resp-007-german-pacing-stability-follow-up.json", "RESP-007 German pacing stability case file"),
    ...
    ("file.research_case_voice_041_private_pattern_profile", "research/experiments/cases/voice-041-private-pattern-profile.json", "VOICE-041 private pattern profile case file"),
    ("file.research_case_voice_042_private_pattern_live_ab", "research/experiments/cases/voice-042-private-pattern-live-ab.json", "VOICE-042 private pattern live A/B case file"),
    ("file.research_case_voice_043_baseline_shaped_runtime", "research/experiments/cases/voice-043-baseline-shaped-runtime-acceptance.json", "VOICE-043 baseline shaped runtime acceptance case file"),
    ("file.research_case_voice_044_baseline_delivery_polish", "research/experiments/cases/voice-044-baseline-delivery-polish.json", "VOICE-044 baseline delivery polish case file"),
