...
EXPERIMENT_ID = "RESP-005-runtime-version-ab-listening-check"
DEFAULT_CASES = ROOT / "research" / "experiments" / "cases" / "resp-005-runtime-version-ab-listening-check.json"
...
def build_runtime_packet(case: dict[str, Any], campaign: dict[str, Any], provider_key: str) -> dict[str, Any]:
    ...
    return attach_runtime_voice_delivery(
        ...
        seed=f"{case['case_id']}:resp-005-runtime-version-ab",
    )
...
def run_variant(
    *,
    ...
    return {
        ...
        "asset_log": {
            "asset_log_id": "RESP-005-generated-audio-asset-log",
            ...
            "input_source_status": "synthetic project-local test case",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run RESP-005 same-question old/new runtime listening check.")
    parser.add_argument("--cases", default=str(DEFAULT_CASES), help="RESP-005 case JSON.")
