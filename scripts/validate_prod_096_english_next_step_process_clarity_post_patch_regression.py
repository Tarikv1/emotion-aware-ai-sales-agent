...
CASE_FILE = ROOT / "research" / "experiments" / "cases" / "prod-096-english-next-step-process-clarity-post-patch-regression.json"

REQUIRED_FILES = {
    "module": ROOT / "scripts" / "prod_096_english_next_step_process_clarity_post_patch_regression.py",
    "runner": ROOT / "scripts" / "run_prod_096_english_next_step_process_clarity_post_patch_regression.py",
    "validator": ROOT / "scripts" / "validate_prod_096_english_next_step_process_clarity_post_patch_regression.py",
    ...
    "doc": ROOT / "docs" / "product" / "PROD_096_ENGLISH_NEXT_STEP_PROCESS_CLARITY_POST_PATCH_REGRESSION.md",
...
GENERATED_FILES = {
    ...
    "process_clarity_regression_cases": OUT_DIR / "process_clarity_regression_cases.json",
...
def validate_case_file() -> None:
    ...
    assert_condition(payload["scope"] == "english_next_step_process_clarity_post_patch_regression", payload)
...
def validate_payloads() -> None:
    ...
    positives = read_json(GENERATED_FILES["process_clarity_regression_cases"])
    ...
    assert_condition(summary["process_clarity_positive_failures"] == 0, summary)
...
def validate_docs() -> None:
    ...
    for marker in [
        "prod-096",
        "english next-step process clarity post-patch regression",
