...
PROMPT_MARKERS = (
    ...
    "After email confirmation, close with the end-of-day timing",
    "If the buyer gives an email and asks a process question",
...
EMAIL_MARKERS = (
    ...
    "Confirm it before saying the mockup will be sent.",
    "I've got brightlanedental@gmail.com - is that right?",
    "normalized_email_confirmation_required",
)

ANALYSIS_EMAIL_MARKERS = (
    "normalized_email_confirmation_required",
    "before saying the mockup will be sent",
...
ANALYSIS_IDS = (
    ...
    "delivery_timing_correct",
    "email_reply_path_mentioned_when_closing",
    "normalized_email_confirmation_required",
    "terminal_close_natural",
...
def assert_kb_rules() -> None:
    ...
    assert_condition("I'll stop here" in output and "Do not use" in output, "Output rules missing unnatural terminal-close ban")
