...
- `reason-product-inbound-demo`: `queued`, prompt chars `2528`, response chars `152`
...
- `reason-workflow-handoff-review`: `queued`, prompt chars `2529`, response chars `145`
...
- `reason-selected-handoffs-price`: `queued`, prompt chars `2685`, response chars `166`
...
- `reason-selected-handoff-delay`: `queued`, prompt chars `2674`, response chars `166`
- `reason-selected-callback-urgency`: `queued`, prompt chars `2701`, response chars `152`
- `reason-selected-owner-confusion`: `queued`, prompt chars `2691`, response chars `166`
...
- `reason-fit-situation`: `queued`, prompt chars `2504`, response chars `101`
- `reason-fit-relevant`: `queued`, prompt chars `2486`, response chars `101`
- `reason-fit-small-team`: `queued`, prompt chars `2507`, response chars `164`
- `reason-fit-low-volume`: `queued`, prompt chars `2582`, response chars `101`
- `reason-fit-current-crm`: `queued`, prompt chars `2599`, response chars `101`
- `reason-fit-team-process`: `queued`, prompt chars `2515`, response chars `101`
...
- `reason-effort-switching`: `queued`, prompt chars `2572`, response chars `101`
