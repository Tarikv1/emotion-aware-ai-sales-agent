...
- Provider calls made in inspected artifact: `true`
- Audio file created in inspected artifact: `true`
- Live provider call used by this validator: `false`
- Secret-like content found: `false`

## Patch Evidence

- Audio URL helper: `/audio?path=data/private/live-demo-001/audio/file%20name.mp3`
- Existing artifact serving: `200` / `audio/mpeg`
- Browser playback error handling: `True`
