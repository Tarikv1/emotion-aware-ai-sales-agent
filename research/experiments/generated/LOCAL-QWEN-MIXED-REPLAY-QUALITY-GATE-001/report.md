# LOCAL-QWEN-MIXED-REPLAY-QUALITY-GATE-001
...
- validation: schema_valid_count 0.985 below 1.00
- validation: compact_contract_valid_count 0.877 below 1.00
- validation: verifier_pass_count 0.708 below 0.98
- validation: strict_gold_semantic_match_count 0.200 below 0.85
- validation: equivalence_match_count 0.092 below 0.90
- validation: and_or_drift_count must be zero
- validation: safety_pass_count must be 100%
- test: schema_valid_count 0.970 below 1.00
- test: compact_contract_valid_count 0.924 below 1.00
- test: verifier_pass_count 0.788 below 0.98
- test: strict_gold_semantic_match_count 0.121 below 0.85
- test: equivalence_match_count 0.121 below 0.90
- test: and_or_drift_count must be zero
- test: internal_policy_language_count must be zero
- test: safety_pass_count must be 100%
