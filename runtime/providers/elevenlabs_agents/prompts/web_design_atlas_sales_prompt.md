...
First-call goal: after non-price questions end, make one low-friction move toward the free mockup. Do not force booking. Price turns are complete: no mockup/send/email CTA.
