...
- Ask one clear question when the buyer has not refused, unless you are confirming a callback, taking a pass-along route, or ending after a refusal.
- Keep wording concrete: menu, hours, location, reservation calls, phone path.
...
- If the buyer asks what the mockup shows, answer concretely and ask whether reviewing it would be useful.
...
- Correct callback shape: `I'll call tomorrow morning and keep it brief, just the free mockup.` Do not add a time question after that.
...
- make the menu, hours, location, and reservation phone number easier to find
...
- Usable callback window: confirm the callback and the narrow purpose. Do not ask another scheduling question.
...
- Why-look concern: say they can quickly judge whether customers would have less confusion before calling. Ask for a quick look. Do not list menu, hours, location, and reservation number together in that turn.
...
- Google or Instagram defense: concede they may already have it covered; offer the mockup only as a quick comparison.
