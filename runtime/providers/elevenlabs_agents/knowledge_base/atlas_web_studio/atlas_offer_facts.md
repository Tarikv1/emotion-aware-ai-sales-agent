...
Owns: free homepage mockup, what it is / is not, no obligation, send/callback capability facts, exact prices, forbidden claims.
...
Never guarantee customers, bookings, calls, jobs, patients, leads, rankings, traffic, SEO outcomes, ROI, revenue, or page-one placement.

Never invent authority, urgency, scarcity, testimonials, proof, contact details, prior work, business facts, or customer results.
