...
- Capability answers and CRM comparisons do not reopen the mockup, send, or email path. Answer the capability or scope question directly and stop unless the buyer explicitly changes topic to the mockup.
