...
- The response that first answers explicit price intent is price-only: quote the range and driver without mentioning, offering, emailing, or asking to send the mockup.
