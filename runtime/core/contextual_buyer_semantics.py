...
def _frame(
    *,
    ...
    conjunction_relation: str = "unknown",
    negation_scope: str = "none",
    buyer_state: str = "unknown",
    commercial_intent: str = "unknown",
    evidence_terms: list[str] | None = None,
    normalized_entities: dict[str, Any] | None = None,
    raw_buyer_meaning_summary: str = "",
    buyer_facing_summary: str = "",
    state_updates: dict[str, Any] | None = None,
    forbidden_routes: list[str] | None = None,
    response_strategy: str = "",
    response_variation_key: str = "",
    next_best_sales_action: str = "",
    should_answer_directly: bool = False,
    should_ask_clarifying_question: bool = False,
    should_recommend: bool = False,
    should_close: bool = False,
    should_disqualify: bool = False,
    should_not_route_to_stability_guard: bool = False,
    buyer_friction_level: str = "low",
    buyer_confusion_level: str = "low",
    buyer_skepticism_level: str = "low",
    buyer_engagement_level: str = "medium",
    buyer_affect_source: str = "none",
) -> dict[str, Any]:
    ...
    return {
        ...
        "object_mentions": list(object_mentions or []),
        "relation_type": relation_type,
        "conjunction_relation": conjunction_relation,
        "negation_scope": negation_scope,
        "buyer_state": buyer_state,
        "commercial_intent": commercial_intent,
        "evidence_terms": list(evidence_terms or []),
        "normalized_entities": dict(normalized_entities or {}),
        ...
        "forbidden_routes": [item for item in list(forbidden_routes or []) if item],
        ...
        "should_ask_clarifying_question": bool(should_ask_clarifying_question),
        "should_recommend": bool(should_recommend),
        "should_close": bool(should_close),
        "should_disqualify": bool(should_disqualify),
        "should_not_route_to_stability_guard": bool(should_not_route_to_stability_guard),
