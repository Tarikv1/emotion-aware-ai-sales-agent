...
LOCAL_VOICE_IDS_PATH = ROOT / "runtime" / "config" / "local" / "voice_ids.json"
LEGACY_LOCAL_VOICE_IDS_PATH = ROOT / "config" / "local" / "voice_ids.json"
...
def load_local_voice_ids(config_path: Path = LOCAL_VOICE_IDS_PATH) -> dict[str, Any]:
    ...
    if resolved_config_path == LOCAL_VOICE_IDS_PATH and not resolved_config_path.is_file():
        resolved_config_path = LEGACY_LOCAL_VOICE_IDS_PATH
