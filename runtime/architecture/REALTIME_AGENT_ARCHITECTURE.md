...
See `runtime/policy/CALL_TERMINATION_POLICY.md` for the dedicated hang-up, transfer, bridge, and schedule-and-end rules.
...
See `runtime/entrypoints/REALTIME_TURN_CLI.md`.
